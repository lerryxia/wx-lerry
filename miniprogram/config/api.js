...
const ApiBaseUrl = 'https://www.lerry.xyz' // 生产上
...
const Config = {
  ...
  logo: 'https://data.lerry.xyz/image/boy.png', // 选填，填写将提高首页加载速度
  blogTitle: '文初lerry' // 选填，填写将提高首页加载速度
}
/**
...
// 关于页面中个人信息，置空不显示
const PersonalInfo = {
  blog: 'https://www.lerry.xyz',
  qq: '1760612636',
  微信: 'lerryxia',
  mail: 'lerryxia@foxmail.com',
  github: 'https://github.com/lerryxia',
  gitee: 'https://gitee.com/lerryxia'
}
